...
from kubernetes.client.apis.voyager_appscode_com_v1beta1_api import VoyagerAppscodeComV1beta1Api
...
class TestVoyagerAppscodeComV1beta1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.apis.voyager_appscode_com_v1beta1_api.VoyagerAppscodeComV1beta1Api()
