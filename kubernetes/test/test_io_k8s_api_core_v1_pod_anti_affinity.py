...
from kubernetes.client.models.io_k8s_api_core_v1_pod_anti_affinity import IoK8sApiCoreV1PodAntiAffinity
...
class TestIoK8sApiCoreV1PodAntiAffinity(unittest.TestCase):
    ...
    def testIoK8sApiCoreV1PodAntiAffinity(self):
        ...
        #model = kubernetes.client.models.io_k8s_api_core_v1_pod_anti_affinity.IoK8sApiCoreV1PodAntiAffinity()
        pass
