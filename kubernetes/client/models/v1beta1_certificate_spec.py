...
class V1beta1CertificateSpec(object):
    ...
    def __init__(self, acme_staging_url=None, acme_user_secret_name=None, challenge_provider=None, domains=None, email=None, http_provider_ingress_reference=None, paused=None, provider=None, provider_credential_secret_name=None, storage=None):
        """
    ...
    def paused(self):
        """
        Gets the paused of this V1beta1CertificateSpec.
        Indicates that the certificate is paused.

        :return: The paused of this V1beta1CertificateSpec.
        :rtype: bool
        """
        return self._paused
    ...
    def paused(self, paused):
        """
        Sets the paused of this V1beta1CertificateSpec.
        Indicates that the certificate is paused.

        :param paused: The paused of this V1beta1CertificateSpec.
        :type: bool
        """
