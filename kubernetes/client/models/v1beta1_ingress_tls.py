...
class V1beta1IngressTLS(object):
    ...
    swagger_types = {
        'hosts': 'list[str]',
        'ref': 'V1beta1LocalTypedReference',
        'secret_name': 'str'
    }
    ...
    def __init__(self, hosts=None, ref=None, secret_name=None):
        """
    ...
    def ref(self):
        """
        Gets the ref of this V1beta1IngressTLS.
        Ref to used tls termination.

        :return: The ref of this V1beta1IngressTLS.
    ...
    def ref(self, ref):
        """
        Sets the ref of this V1beta1IngressTLS.
        Ref to used tls termination.

        :param ref: The ref of this V1beta1IngressTLS.
